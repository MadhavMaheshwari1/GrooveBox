...
const Navbar = () => {
  ...
  return (
    <>
      <div className="fixed z-30 max-w-[1880px] w-full h-full" onClick={() => setShowMenu(false)}>
          ...
          <div className="flex w-full justify-between items-center">
            ...
            <div className="flex gap-4 items-center">
              ...
              <div className="relative cursor-pointer flex justify-center items-center hover:scale-105 group transition-all duration-500">
                ...
                {!showMenu && (<div className="opacity-0 group-hover:opacity-100 top-20 transition-all font-semibold duration-600 absolute text-white bg-[rgba(66,74,87,0.58)] rounded-md py-2 px-4 z-[1]">Madhav</div>)}
                {showMenu && (
                  <div className="absolute lg:w-[200px] lg:h-[150px] lg:text-xl text-md w-[160px] h-[120px] bg-[rgba(66,74,87,0.58)] flex items-center justify-center md:top-24 top-16 right-0 z-[1] rounded-xl py-4 text-white text-xl cursor-pointer">
                    <div className="flex flex-col lg:gap-4 gap-2">
                      <Link to={external_urls.spotify} className='flex justify-between lg:w-[180px] w-[130px] mx-auto bg-[rgba(66,74,87,0.86)] py-2 px-3 rounded-xl'><UserRoundPen />Profile</Link>
                      <button onClick={() => logoutHandler()} className='flex justify-between lg:w-[180px] w-[130px] mx-auto bg-[rgba(66,74,87,0.86)] py-2 px-3 rounded-xl'><LogOut />Logout</button>
                    </div>
                  </div>)
                }
              </div>
