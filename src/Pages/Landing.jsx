  ...
  return (
    <div className="max-w-[1850px] mx-auto flex xl:flex-row flex-col h-[100vh] py-8 xl:px-8">
      <div className="xl:w-1/2 w-full flex flex-col gap-4 justify-center px-8 xl:items-start items-center xl:ps-0 pt-8 pb-4">
        <p className="xl:text-7xl md:text-6xl text-3xl text-white xl:text-start text-center">Enjoy the music, live life to the fullest.</p>
        <p className="xl:text-2xl md:text-xl text-sm text-white px-1 xl:text-start text-center">Listen for your favourite music wherever you are.</p>
        <button className="md:py-3 md:px-4 py-1 px-2 bg-gradient-to-r from-blue-400 font-semibold to-blue-900 rounded-3xl text-white xl:w-[250px] md:w-[200px] w-[150px] sm:text-[16px] text-[12px] flex justify-between items-center">Login with spotify <span>
        ...
        <div className="flex cursor-pointer">
          <picture>
            <source
              ...
              sizes="(max-width: 600px) 40vw, (max-width: 1200px) 15vw"
              type="image/avif"
            />
            <img src={HeadphonesSmall} width="500px" height="500px" alt="Description of the image" />
          </picture>
